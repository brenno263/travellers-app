...
export type AnswererStatus =
	| "uninitialized"
	| "waiting_for_datachannel"
	| "connected";
...
export const RTCAnswererPanel: FC = () => {
	...
	const [answererStatus, setAnswererStatus] =
		useState<AnswererStatus>("uninitialized");
	...
	const handleInitialize = async () => {
		...
		setAnswererStatus("waiting_for_datachannel");
	...
	return (
		<div className="card">
			<h1>Answerer Test</h1>
			<p>Answerer Status: {answererStatus}</p>
